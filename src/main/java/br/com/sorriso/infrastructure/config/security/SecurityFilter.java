...
import org.springframework.security.config.annotation.web.builders.HttpSecurity;
    ...
    import br.com.sorriso.infrastructure.jwt.JwtAuthenticationFilter;

    @Configuration
    public class SecurityFilter {
        // Rotas padrão
        public static final String BASE_URL = "/sorriso/api";
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            http
                ...
                .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers(BASE_URL + "**").hasRole(RoleType.ROLE_ATTENDANT.getName())
                    .requestMatchers(BASE_URL + "/users/register").permitAll()
                    .requestMatchers(BASE_URL + "/users/login").permitAll()
                    .requestMatchers(BASE_URL + "/users/{userId}/update-password").hasRole(RoleType.ROLE_DENTIST.getName())
                    .requestMatchers(BASE_URL + "/users/{userId}/update-username").hasRole(RoleType.ROLE_DENTIST.getName())
